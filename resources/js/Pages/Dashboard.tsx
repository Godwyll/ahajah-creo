			...
			<div className="py-6">
				<div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-4 flex flex-wrap gap-2 text-sm justify-end">
                        <a href="#" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 ring-1 ring-inset ring-indigo-600/20">
                        ...
                        <a href="#" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-300 dark:hover:bg-slate-700 ring-1 ring-inset ring-slate-200/70 dark:ring-slate-700/60">
